...
export default function Footer() {
    return (
        <>
            <footer className="py-5 p-5 mt-5" style={{ background:"rgb(2,0,36)"}}
                // style={{ background: "linear-gradient(0deg, rgba(22,86,247,1) 0%, rgba(134,246,249,1) 100%)" }}
                // style={{ background: "linear-gradient(0deg, rgba(15,8,237,1) 0%, rgba(255,255,255,1) 52%)" }}
            >
                <div className="row">
                    <div className="col-2 m-1">
                        <h6 className='text-light'>Section</h6>
                ...
                <div className="d-flex justify-content-between py-4 my-4 border-top">
                    <p className='text-light'>© 2021 Company, Inc. All rights reserved.</p>
                    <ul className="list-unstyled d-flex">
                        <li className="ms-3"><Link className="link-dark" to="/">
                            <div className="icon h2">
                                <svg stroke="currentColor" className='bg-light'
                                // fill="currentColor" 
                                strokeWidth="0"
